    ...
    <div class="container-fluid">
        ...
        <div class="navbar-left">
            <div class="navbar-btn">
                ...
                <a href="{{ route('home') }}"><img src="{{ asset('uploads/backend/settings/'.mainSettingsData()['logo']) }}" alt="{{ mainSettingsData()['title'] }}" class="img-fluid logo"></a>
                @else
                <a href="{{ route('home') }}"><img src="{{ asset('dashboard/assets/images/icon.svg') }}" alt="{{ transWord('Dashboard') }}" class="img-fluid logo"></a>
                @endif

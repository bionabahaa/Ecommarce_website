                                ...
                                <tr>
                                    ...
                                    <td bgcolor="#ffffff" width="400" align="right" class="mobile-hide">
                                        <table border="0" cellpadding="0" cellspacing="0">
                                            <tr>
                                                <td align="right" style="padding: 0 0 5px 0; font-size: 14px; font-family: Arial, sans-serif; color: #666666; text-decoration: none;"><span style="color: #666666; text-decoration: none;">@if(mainSettingsData() != null) {{ mainSettingsData()['title'] }} @else {{ transWord('Project Name') }} @endif</span></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
